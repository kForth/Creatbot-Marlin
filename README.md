...
## Wanhao Duplicator i3 v2.1 Branch

This branch is for Marlin v2.1.x for the Wanhao Duplicator i3 v2.1, it is based on the upstream bugfix-2.1.x branch and [this example configuration](https://github.com/MarlinFirmware/Configurations/tree/bugfix-2.1.x/config/examples/Wanhao/Duplicator%20i3%202.1).
...
This branch is for patches to the latest 2.1.x release version. Periodically this branch will form the basis for the next minor 2.0.x release.
