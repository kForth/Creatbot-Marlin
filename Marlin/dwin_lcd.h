...
#if HAS_READER
	#define FILE_NAME_LEN	(LCD_FILE_CHAR_LEN < (LONG_FILENAME_LENGTH - 1) ? \
							 LCD_FILE_CHAR_LEN : (LONG_FILENAME_LENGTH - 1))
#endif
...
#define PAGE_NORMAL_SERIAL_USB					"0021"	//33
#define PAGE_NORMAL_SERIAL_SD					"0022"	//34
...
*/
...
#if HAS_READER
	#ifdef SDSUPPORT
		// #define PAGE_NORMAL_SERIAL						PAGE_NORMAL_SERIAL_SD
		...
		// #define PAGE_NORMAL_SERIAL						PAGE_NORMAL_SERIAL_USB
...
#define PAGE_NORMAL_SERIAL								PAGE_STATE_PRINT
