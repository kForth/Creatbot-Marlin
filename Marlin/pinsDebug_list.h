...
#endif
#if PIN_EXISTS(FILAMENT_0)
  REPORT_NAME_DIGITAL(FILAMENT_0_PIN, __LINE__ )
#endif
#if PIN_EXISTS(FILAMENT_1)
  REPORT_NAME_DIGITAL(FILAMENT_1_PIN, __LINE__ )
#endif
#if PIN_EXISTS(FILAMENT_2)
  REPORT_NAME_DIGITAL(FILAMENT_2_PIN, __LINE__ )
#endif
#if PIN_EXISTS(PS_OFF)
  REPORT_NAME_DIGITAL(PS_OFF_PIN, __LINE__ )
#endif
#if PIN_EXISTS(AIR_FAN)
  REPORT_NAME_DIGITAL(AIR_FAN_PIN, __LINE__ )
#endif
#if PIN_EXISTS(HEATER_CHAMBER)
  REPORT_NAME_DIGITAL(HEATER_CHAMBER_PIN, __LINE__ )
#endif
#if defined(USB_SS) && USB_SS >= 0
  REPORT_NAME_DIGITAL(USB_SS, __LINE__ )
#endif
#if defined(USB_MOSI) && USB_MOSI >= 0
  REPORT_NAME_DIGITAL(USB_MOSI, __LINE__ )
#endif
#if defined(USB_MISO) && USB_MISO >= 0
  REPORT_NAME_DIGITAL(USB_MISO, __LINE__ )
#endif
#if defined(USB_SCK) && USB_SCK >= 0
  REPORT_NAME_DIGITAL(USB_SCK, __LINE__ )
#endif
#if defined(USB_INT) && USB_INT >= 0
  REPORT_NAME_DIGITAL(USB_INT, __LINE__ )
#endif
#if defined(ESP8266_RST) && ESP8266_RST >= 0
  REPORT_NAME_DIGITAL(ESP8266_RST, __LINE__ )
#endif
