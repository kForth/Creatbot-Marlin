...
void GcodeSuite::M42() {
  ...
  const byte pin_status = parser.value_byte();
    ...
    switch (pin) {
      #if HAS_FAN0
        case FAN0_PIN: tempSensors.fan_speed[0] = pin_status; return;
      #endif
      #if HAS_FAN1
        case FAN1_PIN: tempSensors.fan_speed[1] = pin_status; return;
      #endif
      #if HAS_FAN2
        case FAN2_PIN: tempSensors.fan_speed[2] = pin_status; return;
      #endif
      #if HAS_FAN3
        case FAN3_PIN: tempSensors.fan_speed[3] = pin_status; return;
      #endif
      #if HAS_FAN4
        case FAN4_PIN: tempSensors.fan_speed[4] = pin_status; return;
      #endif
      #if HAS_FAN5
        case FAN5_PIN: tempSensors.fan_speed[5] = pin_status; return;
      #endif
      #if HAS_FAN6
        case FAN6_PIN: tempSensors.fan_speed[6] = pin_status; return;
      #endif
      #if HAS_FAN7
        case FAN7_PIN: tempSensors.fan_speed[7] = pin_status; return;
      #endif
    }
  #endif
