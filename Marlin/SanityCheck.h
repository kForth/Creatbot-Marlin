 ...
 */
  ...
  #if !HAS_READER
    #error "LCD_PROGRESS_BAR requires FILE_READER."
  #elif ENABLED(DOGLCD)
 ...
 */
  ...
  #elif !HAS_READER && DISABLED(PRINTJOB_TIMER_AUTOSTART)
    #error "FILAMENT_RUNOUT_SENSOR requires FILE_READER or PRINTJOB_TIMER_AUTOSTART."
 ...
 */
  ...
  #if DISABLED(NEWPANEL) && DISABLED(DWIN_LCD)
    #error "ADVANCED_PAUSE_FEATURE currently requires an LCD controller."
  #elif ENABLED(EXTRUDER_RUNOUT_PREVENT)
    #error "EXTRUDER_RUNOUT_PREVENT is incompatible with ADVANCED_PAUSE_FEATURE."
  #elif ENABLED(PARK_HEAD_ON_PAUSE) && !HAS_READER && DISABLED(NEWPANEL) && DISABLED(EMERGENCY_PARSER)
    #error "PARK_HEAD_ON_PAUSE requires FILE_READER, EMERGENCY_PARSER, or an LCD controller."
...
#if ENABLED(QUICK_PAUSE) && !HAS_READER && DISABLED(UDISKSUPPORT)
