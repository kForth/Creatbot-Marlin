...
#define STRING_CONFIG_H_AUTHOR "Stern Laboratories Inc." // Who made the changes.
...
#define HOTEND_OFFSET_X { 0.0, 73.00 } // (mm) relative X-offset for each nozzle
...
#define CHAMBER_OVERSHOOT 15   // (°C) Forbid temperatures over MAXTEMP - OVERSHOOT
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.6878, 131.0226, 640, 130 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 110, 110, 20, 40 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 36, 72, -3.3 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (50 + 36)  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT (50 + 72)  // Y point for Z homing
#endif
