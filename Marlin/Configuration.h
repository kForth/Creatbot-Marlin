...
//#define SHOW_BOOTSCREEN // DGUS display has its own boot screen
...
// Enable to use version information in Marlin/_Version.h
...
// Please choose the name from boards.h that matches your setup
  ...
  // The stepper driver step and direction pins are swapped on newer F430 (and other?) motherboards.
  // Uncomment this if you have a motherboard version greater than 9.5, probably yellow PCB.
  // Leave this commented if you have an older motherboard, probably a green PCB.
  // #define CREATBOT_MOTHERBOARD_GT95
#endif
...
#define E1_DRIVER_TYPE TB6560  // Supposedly a THB6032
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.6816, 131.2591, 638.0153, 130 }
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 72  // Y offset: -front +behind [the nozzle]
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // Set the boundaries for probing (where the probe can reach).d
