...
#define STRING_CONFIG_H_AUTHOR "K.Goforth" // Original author or contributor.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 66.162
  #define DEFAULT_bedKi 0.425
  #define DEFAULT_bedKd 2575.371
