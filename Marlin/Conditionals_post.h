...
#define HAS_TEMP_SENSOR (HAS_TEMP_HOTEND || HAS_HEATED_BED || HAS_TEMP_CHAMBER) // TODO
...
#define WATCH_THE_CHAMBER (HAS_THERMALLY_PROTECTED_CHAMBER && WATCH_CHAMBER_TEMP_PERIOD > 0) // TODO
