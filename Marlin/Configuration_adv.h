...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { DEFAULT_FEEDRATE_XY, DEFAULT_FEEDRATE_XY, DEFAULT_FEEDRATE_Z } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define G0_FEEDRATE DEFAULT_FEEDRATE_XY // (mm/min)
#ifdef G0_FEEDRATE
